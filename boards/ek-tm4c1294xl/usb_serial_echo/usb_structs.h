...
//
//*****************************************************************************
#define UART_BUFFER_SIZE        2248
#define NUM_SERIAL_DEVICES      1

extern uint32_t USBCDC_RxHandler(void *pvCBData, uint32_t ui32Event,
                             uint32_t ui32MsgValue, void *pvMsgData);
extern uint32_t USBCDC_TxHandler(void *pvlCBData, uint32_t ui32Event,
                             uint32_t ui32MsgValue, void *pvMsgData);
